...
import com.project_android.realtimechat.databinding.ActivitySignUpBinding;
    ...
    private void signUp() {
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    // THAY ĐỔI TẠI ĐÂY:
                    // 1. Không lưu IsSignedIn = true vào preferenceManager nữa.
                    // 2. Chuyển hướng về màn hình SignInActivity.

                    Intent intent = new Intent(getApplicationContext(), SignInActivity.class);
                    // Truyền Email vừa đăng ký sang để người dùng đỡ phải gõ lại (Tùy chọn)
