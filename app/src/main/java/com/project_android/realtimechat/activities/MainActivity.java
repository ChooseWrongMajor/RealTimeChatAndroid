...
import com.project_android.realtimechat.adapters.RecentConversationsAdapter;
import com.project_android.realtimechat.databinding.ActivityMainBinding;
import com.project_android.realtimechat.listeners.ConversionListener;
...
public class MainActivity extends BaseActivity implements ConversionListener {
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                ...
                if (documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    if (preferenceManager.getString(Constants.KEY_USER_ID)
                        ...
                        chatMessage.conversionId = documentChange.getDocument()
                                .getString(Constants.KEY_RECEIVER_ID);
    ...
    private void signOut() {
        ...
        // Xóa token khỏi Firestore khi đăng xuất để không nhận thông báo nữa
